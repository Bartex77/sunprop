...
class AmenityController extends AbstractController
{
    ...
    {
        return $this->render('amenity/index.html.twig', ['amenities' => $amenityRepository->findBy([], ['showOrder' => 'ASC'])]);
    }
    ...
    {
        return $this->render('amenity/show.html.twig', ['amenity' => $amenity]);
    }
    ...
    public function edit(Request $request, Amenity $amenity): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('amenity_index', ['id' => $amenity->getId()]);
        }
